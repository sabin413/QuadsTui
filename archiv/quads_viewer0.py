...
class QuadsViewer(App):
    ...
    RAW_COLUMNS = ["time", "lat", "lon", "lev", "raw data"]
    MAX_RAW_ROWS = 1000
        ...
        with Vertical(id="right"):
            ...
            with Horizontal(id="bottom_area"):
                ...
                with Vertical(id="raw_panel"):
                    yield Static(
                        'Out of fence raw data (hit "s" to save this data for your analysis)',
                        id="raw_title",
                    )
    ...
    def handle_pickle_loaded(self, event: PickleLoaded) -> None:
        ...
        parquet_files = sorted(self.current_path.parent.glob("*.parquet"))
    ...
    def update_file_summary(self) -> None:
        ...
        ref = historical_reference_window(date)
